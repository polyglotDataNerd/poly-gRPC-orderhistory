...
func init() {
	proto.RegisterType((*HistoryRequest)(nil), "definition.HistoryRequest")
	proto.RegisterType((*HistoryMap)(nil), "definition.HistoryMap")
	proto.RegisterType((*HistoryResponse)(nil), "definition.HistoryResponse")
}
...
func (c *sGHistoryClient) GetUserHistory(ctx context.Context, in *HistoryRequest, opts ...grpc.CallOption) (SGHistory_GetUserHistoryClient, error) {
	stream, err := c.cc.NewStream(ctx, &_SGHistory_serviceDesc.Streams[0], "/definition.SGHistory/GetUserHistory", opts...)
	if err != nil {
		return nil, err
	}
...
var _SGHistory_serviceDesc = grpc.ServiceDesc{
	ServiceName: "definition.SGHistory",
